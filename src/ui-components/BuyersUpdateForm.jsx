...
export default function BuyersUpdateForm(props) {
  const {
    id: idProp,
    buyers,
    onSuccess,
  ...
  const resetStateValues = () => {
    const cleanValues = buyersRecord
      ? { ...initialValues, ...buyersRecord }
      : initialValues;
  ...
  const [buyersRecord, setBuyersRecord] = React.useState(buyers);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp ? await DataStore.query(Buyers, idProp) : buyers;
      setBuyersRecord(record);
    };
    queryData();
  }, [idProp, buyers]);
  React.useEffect(resetStateValues, [buyersRecord]);
  const validations = {
    phone_number: [],
    name: [],
    address: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Buyers.copyOf(buyersRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "BuyersUpdateForm")}
      {...rest}
    >
      <TextField
        label="Phone number"
